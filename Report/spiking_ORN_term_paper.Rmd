---
title: "Modeling of spiking olfactory receptors using a molecular transduction model"
author: |
  | Shivansh Dave 
...
A.  **Transduction simulation matches experimental data in shape but not in peak-response**
